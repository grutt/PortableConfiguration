...
[core]
s0_active_plugins = core;composite;opengl;resize;vpswitch;place;session;snap;commands;copytex;compiztoolbox;imgpng;grid;mousepoll;wall;regex;animation;move;unitymtgrabhandles;expo;workarounds;fade;ezoom;scale;unityshell;
s0_outputs = 900x1440+2880+0;1440x900+0+195;1440x900+1440+219;
s0_autoraise = false
...
[grid]
s0_put_left_key = <Control>Left
s0_put_right_key = <Control>Right
s0_put_top_key = <Control>Up
s0_put_bottom_key = <Control>Down
s0_put_topleft_key = <Shift><Control>Left
s0_put_topright_key = <Shift><Control>Right
s0_put_bottomleft_key = <Control><Alt>Left
s0_put_bottomright_key = <Control><Alt>Right
s0_put_maximize_key = <Shift><Control>Up
